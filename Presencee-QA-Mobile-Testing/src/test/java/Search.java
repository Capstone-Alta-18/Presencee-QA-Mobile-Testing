...
public class Search {
    public static void main(String[] args) throws MalformedURLException {
        ...
        try {
            // User can search matakuliah in field Search
            ...
            masukButton.click();
            WebElement searchField = driver.findElement(AppiumBy.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText"));
            searchField.click();
            searchField.sendKeys("Akuntansi");
